...
#let poster(
  ...
  let supervisors = {
    ...
    _utils.i18n(de: [Betreuer: ], en: [Supervisors: ])
    doc
      .supervisors
    ...
    grid(
      ...
      block(width: 105mm, height: 140mm, fill: theme.accent-primary),
      {
        text(size: 54pt, strong(
          authors.format-author(doc.author, email: false, titles: false)
        ))
        linebreak()
        text(size: 42pt, cv)
      },
